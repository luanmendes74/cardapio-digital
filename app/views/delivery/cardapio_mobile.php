            ...
            <div class="bg-white rounded-t-lg shadow-xl w-full max-h-[90vh] overflow-hidden">
                ...
                <form id="dados-cliente-form" class="p-4 space-y-4 max-h-96 overflow-y-auto">
                    ...
                    <div>
                        ...
                        <textarea name="cliente_endereco" required rows="3" class="w-full px-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primaria focus:border-transparent text-base"></textarea>
                    </div>
                    
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Observações</label>
                        <textarea name="observacoes" rows="2" class="w-full px-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primaria focus:border-transparent text-base"></textarea>
                    </div>
