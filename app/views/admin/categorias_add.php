...
<div class="p-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
        <div>
            <h2 class="text-3xl font-bold text-gray-900">Adicionar Categoria</h2>
            <p class="text-gray-600 mt-1">Crie uma nova categoria para organizar seus produtos</p>
        </div>
    </div>
    ...
    <div class="max-w-2xl">
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
            <form action="<?= URL_BASE ?>/admin/addcategoria" method="post">
                <div class="space-y-6">
                    <!-- Nome da Categoria -->
                    <div>
